...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/chris/catkin_ws/src/rotors_simulator/rotors_evaluation)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chris/catkin_ws/src/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chris/catkin_ws/devel/.private/rotors_evaluation/lib;/home/chris/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
