...
set(MSG_I_FLAGS "-Iplan_manage:/home/chrisliu/ROS/HKUST_ws/src/Fast-Planner/dyn_planner/plan_manage/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chrisliu/ROS/HKUST_ws/src/Fast-Planner/dyn_planner/plan_manage/msg/Bspline.msg" NAME_WE)
add_custom_target(_plan_manage_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plan_manage" "/home/chrisliu/ROS/HKUST_ws/src/Fast-Planner/dyn_planner/plan_manage/msg/Bspline.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(plan_manage
  "/home/chrisliu/ROS/HKUST_ws/src/Fast-Planner/dyn_planner/plan_manage/msg/Bspline.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/plan_manage)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/plan_manage\")")
  # install generated code
  install(
